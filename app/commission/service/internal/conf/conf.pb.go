...
type Auth struct {
	...
	TokenDuration *durationpb.Duration   `protobuf:"bytes,3,opt,name=token_duration,json=tokenDuration,proto3" json:"token_duration,omitempty"`
	SigningMethod string                 `protobuf:"bytes,4,opt,name=signing_method,json=signingMethod,proto3" json:"signing_method,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_internal_conf_conf_proto_rawDesc = "" +
	...
	"\x06schema\x18\x02 \x01(\tR\x06schema\"\xa6\x01\n" +
	"\x04Auth\x12\x16\n" +
	"\x06secret\x18\x01 \x01(\tR\x06secret\x12\x1d\n" +
	"\n" +
	"public_key\x18\x02 \x01(\tR\tpublicKey\x12@\n" +
	"\x0etoken_duration\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\rtokenDuration\x12%\n" +
	"\x0esigning_method\x18\x04 \x01(\tR\rsigningMethodB2Z0agents/app/commission/service/internal/conf;confb\x06proto3"
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	10, // 9: kratos.api.Auth.token_duration:type_name -> google.protobuf.Duration
